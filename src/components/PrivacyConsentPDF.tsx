    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          본 동의서는 '{schoolName}' 학생들이 '오늘의 미션'
          학습 관리 시스템을 이용하기 위해 필요한 최소한의
          개인정보를 수집·이용하는 것에 대한 동의를 받기
          위함입니다.
        </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          수집된 개인정보는 해당 학년도 종료 후 1년간
          보관하며, 이후 즉시 파기합니다. 단, 법령에 의해
          보관이 필요한 경우 해당 법령에서 정한 기간 동안
          보관합니다.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.paragraph}>
          개인정보 수집·이용에 대한 동의를 거부할 권리가
          있습니다. 다만, 동의를 거부할 경우 '오늘의 미션'
          서비스 이용이 제한될 수 있습니다.
        </Text>
      </View>
